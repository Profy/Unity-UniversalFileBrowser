...
namespace System
{
    internal static class NativeMethods
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern IntPtr OpenProcess(ProcessAccessRights access, bool inherit, uint processId);
        #endregion
        ...
        internal enum ProcessAccessRights : uint
        {
            ...
            SYNCHRONIZE = 0x00100000,                   // Required to use the object for synchronization. This enables a thread to wait until the object is in the signaled state.
